...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    particleFile = cms.untracked.string('Configuration/GenProduction/python/ThirteenTeV/DisappTrksHiggsino/test/geant4_higgsino_%sGeV_ctau%scm.slha' % (MCHI, CTAU/10))
)
